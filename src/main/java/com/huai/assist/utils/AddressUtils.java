...
/**
 * 根据IP地址获取详细的地域信息
 * Created by liangyh on 2016-10-19.
 */
public class AddressUtils {
    ...
    public static String getAddressByIP(String ip, String encodingString){
        if(ip != null && encodingString != null) return null;
        String result = null;
        try {
...
//        String ip = "125.81.59.117";
        String ip = "60.160.10.198";
        String address = "";
        /*try {
